...
export default function EnergyMetrics() {
  return (
    <Box sx={{ p: 3, maxWidth: 1100 }}>
      <Typography variant="h5" fontWeight={700} gutterBottom>EnergyMetrics</Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>Sustainability portal - EnergyMetrics tracks carbon, energy, waste, initiatives, audits, certifications.</Typography>
