...
import { applyCompanyFilters, companiesToCsv, EMPTY_FILTERS, sortCompanies } from './CompaniesConsole';

// The Companies list's search / filter / sort / export are pure functions
// over the get_companies_overview() rows; pin their semantics here rather
// than through the (heavy) full-screen render.
