...
drop trigger if exists "trg_notify_proposal_status_change" on "public"."bd_proposals";
...
drop trigger if exists "trg_touch_gl_posting_rules_updated_at" on "public"."gl_posting_rules";
...
drop trigger if exists "trg_notify_contract_status_change" on "public"."law_contracts";
...
drop policy "gl_posting_rules_delete" on "public"."gl_posting_rules";

drop policy "gl_posting_rules_insert" on "public"."gl_posting_rules";

drop policy "gl_posting_rules_select" on "public"."gl_posting_rules";

drop policy "gl_posting_rules_update" on "public"."gl_posting_rules";
...
alter table "public"."gl_posting_rules" drop constraint "gl_posting_rules_gl_account_id_fkey";

alter table "public"."gl_posting_rules" drop constraint "gl_posting_rules_tenant_id_fkey";
...
alter table "public"."bank_reconciliations" add constraint "bank_reconciliations_bank_statement_line_id_fkey" FOREIGN KEY (bank_statement_line_id) REFERENCES public.bank_statement_lines(id) ON DELETE CASCADE not valid;

alter table "public"."bank_reconciliations" validate constraint "bank_reconciliations_bank_statement_line_id_fkey";

alter table "public"."bank_reconciliations" add constraint "bank_reconciliations_cash_bank_transaction_id_fkey" FOREIGN KEY (cash_bank_transaction_id) REFERENCES public.cash_bank_transactions(id) ON DELETE CASCADE not valid;

alter table "public"."bank_reconciliations" validate constraint "bank_reconciliations_cash_bank_transaction_id_fkey";

alter table "public"."bank_reconciliations" add constraint "bank_reconciliations_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."bank_reconciliations" validate constraint "bank_reconciliations_tenant_id_fkey";

alter table "public"."bank_statement_lines" add constraint "bank_statement_lines_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."bank_statement_lines" validate constraint "bank_statement_lines_tenant_id_fkey";
...
alter table "public"."gl_posting_rules" add constraint "gl_posting_rules_gl_account_id_fkey" FOREIGN KEY (gl_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_posting_rules" validate constraint "gl_posting_rules_gl_account_id_fkey";

alter table "public"."gl_posting_rules" add constraint "gl_posting_rules_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."gl_posting_rules" validate constraint "gl_posting_rules_tenant_id_fkey";
...
alter table "public"."statutory_rate_tables" add constraint "statutory_rate_tables_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."statutory_rate_tables" validate constraint "statutory_rate_tables_tenant_id_fkey";
...
BEGIN
  ...
  IF v_invoice.purchase_order_id IS NULL THEN
    RETURN NEW; -- non-PO invoice: no goods-receipt trail to match against
  END IF;
...
create or replace view "public"."v_bank_reconciliation_variance" as  SELECT r.id AS reconciliation_id,
    r.tenant_id,
    r.match_type,
    r.variance,
    r.matched_at,
  ...
  WHERE (r.variance <> (0)::numeric);


create or replace view "public"."v_bank_statement_unmatched" as  SELECT l.id,
    l.tenant_id,
    l.bank_account,
    l.statement_date,
    l.description,
...
create or replace view "public"."v_cash_bank_unmatched" as  SELECT t.id,
    t.tenant_id,
    t.transaction_type,
    t.payment_method,
    t.reference_type,
  ...
  WHERE ((t.payment_method = 'bank'::text) AND (r.id IS NULL));
...
create or replace view "public"."v_paye_nssf_remittance" as  SELECT r.tenant_id,
    r.id AS payroll_run_id,
    r.period,
    r.status,
    r.approved_at,
    count(i.id) AS employee_count,
    COALESCE(sum((i.basic_salary + i.allowances)), (0)::numeric) AS total_gross,
    COALESCE(sum(i.paye_amount), (0)::numeric) AS total_paye,
    COALESCE(sum(i.nssf_employee), (0)::numeric) AS total_nssf_employee,
    COALESCE(sum(i.nssf_employer), (0)::numeric) AS total_nssf_employer,
    COALESCE(sum((i.nssf_employee + i.nssf_employer)), (0)::numeric) AS total_nssf,
    COALESCE(sum(i.net_pay), (0)::numeric) AS total_net_pay,
        CASE
            WHEN (r.approved_at IS NOT NULL) THEN (((date_trunc('month'::text, ((r.approved_at)::date)::timestamp with time zone) + '1 mon'::interval) + '14 days'::interval))::date
            ELSE NULL::date
        END AS remittance_due_date
   FROM (public.hr_payroll_runs r
     LEFT JOIN public.hr_payroll_items i ON ((i.payroll_run_id = r.id)))
  WHERE (r.status = ANY (ARRAY['approved'::text, 'disbursed'::text]))
...
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_posting_rules_delete"
  on "public"."gl_posting_rules"
  as permissive
  for delete
  to public
using ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_posting_rules_insert"
  on "public"."gl_posting_rules"
  as permissive
  for insert
  to public
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_posting_rules_select"
  on "public"."gl_posting_rules"
  as permissive
  for select
  to public
using ((public.is_finance_team_member(NULL::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_posting_rules_update"
  on "public"."gl_posting_rules"
  as permissive
  for update
  to public
...
using (((EXISTS ( SELECT 1
  ...
  WHERE ((pr.id = hr_payroll_items.payroll_run_id) AND (pr.tenant_id = public.get_my_tenant_id())))) AND (public.is_hr_team_member() OR public.is_payroll_approver() OR public.is_finance_team_member('finance'::text) OR (EXISTS ( SELECT 1
   FROM public.hr_employees e
  ...
  for select
  to public
using (((tenant_id = public.get_my_tenant_id()) AND (public.is_hr_team_member() OR public.is_payroll_approver() OR public.is_finance_team_member('finance'::text))));
...
using ((tenant_id = public.get_my_tenant_id()));
  ...
  create policy "statutory_rate_tables_delete"
  on "public"."statutory_rate_tables"
  as permissive
  for delete
  to public
using ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "statutory_rate_tables_insert"
  on "public"."statutory_rate_tables"
  as permissive
  for insert
  to public
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "statutory_rate_tables_select"
  on "public"."statutory_rate_tables"
  as permissive
  for select
  to public
using (((public.is_finance_team_member(NULL::text) OR public.is_hr_team_member(NULL::text)) AND (tenant_id = public.get_my_tenant_id())));



  create policy "statutory_rate_tables_update"
  on "public"."statutory_rate_tables"
  as permissive
  for update
  to public
...
CREATE TRIGGER trg_notify_proposal_status_change AFTER UPDATE ON public.bd_proposals FOR EACH ROW EXECUTE FUNCTION public.notify_proposal_status_change();
...
CREATE TRIGGER trg_touch_gl_posting_rules_updated_at BEFORE UPDATE ON public.gl_posting_rules FOR EACH ROW EXECUTE FUNCTION public.touch_updated_at();
...
CREATE TRIGGER trg_notify_leave_status_change AFTER UPDATE ON public.hr_leave_requests FOR EACH ROW EXECUTE FUNCTION public.notify_leave_status_change();

CREATE TRIGGER trg_post_payroll_run_approval AFTER UPDATE ON public.hr_payroll_runs FOR EACH ROW EXECUTE FUNCTION public.trg_post_payroll_run_approval();
...
CREATE TRIGGER trg_notify_contract_status_change AFTER UPDATE ON public.law_contracts FOR EACH ROW EXECUTE FUNCTION public.notify_contract_status_change();
