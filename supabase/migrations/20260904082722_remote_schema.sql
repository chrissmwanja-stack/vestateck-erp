...
drop policy "accounting_periods_delete" on "public"."accounting_periods";

drop policy "accounting_periods_insert" on "public"."accounting_periods";

drop policy "accounting_periods_select" on "public"."accounting_periods";

drop policy "accounting_periods_update" on "public"."accounting_periods";
...
drop policy "approval_assignments_select" on "public"."approval_assignments";
...
drop policy "gl_accounts_delete" on "public"."gl_accounts";

drop policy "gl_accounts_insert" on "public"."gl_accounts";

drop policy "gl_accounts_select" on "public"."gl_accounts";

drop policy "gl_accounts_update" on "public"."gl_accounts";

drop policy "gl_control_accounts_delete" on "public"."gl_control_accounts";

drop policy "gl_control_accounts_insert" on "public"."gl_control_accounts";

drop policy "gl_control_accounts_select" on "public"."gl_control_accounts";

drop policy "gl_control_accounts_update" on "public"."gl_control_accounts";
...
alter table "public"."accounting_periods" drop constraint "accounting_periods_tenant_id_fkey";
...
alter table "public"."gl_accounts" drop constraint "gl_accounts_tenant_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_ap_control_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_ar_control_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_bank_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_cash_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_default_expense_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_default_revenue_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_tenant_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_vat_input_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_vat_output_account_id_fkey";

alter table "public"."gl_control_accounts" drop constraint "gl_control_accounts_wht_payable_account_id_fkey";
...
alter table "public"."journal_entries" drop constraint "journal_entries_tenant_id_fkey";
...
alter table "public"."journal_entry_lines" drop constraint "journal_entry_lines_tenant_id_fkey";
...
drop function if exists "public"."auto_match_bank_statement"(p_bank_account text, p_date_from date, p_date_to date);

drop function if exists "public"."calculate_statutory_deductions"(p_gross numeric, p_as_of_date date);

drop function if exists "public"."import_bank_statement_lines"(p_bank_account text, p_lines jsonb);

drop function if exists "public"."match_bank_statement_line"(p_statement_line_id uuid, p_cash_bank_transaction_id uuid);

drop function if exists "public"."seed_statutory_rate_table"(p_effective_date date);

drop function if exists "public"."trg_post_payroll_run_approval"();

drop function if exists "public"."unmatch_bank_reconciliation"(p_reconciliation_id uuid);

drop view if exists "public"."v_bank_reconciliation_variance";

drop view if exists "public"."v_bank_statement_unmatched";

drop view if exists "public"."v_cash_bank_unmatched";
...
drop index if exists "public"."bank_reconciliations_tenant_idx";

drop index if exists "public"."bank_reconciliations_transaction_unique";

drop index if exists "public"."bank_statement_lines_pkey";

drop index if exists "public"."bank_statement_lines_tenant_account_date_idx";
...
alter table "public"."accounting_periods" add constraint "accounting_periods_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."accounting_periods" validate constraint "accounting_periods_tenant_id_fkey";
...
alter table "public"."gl_accounts" add constraint "gl_accounts_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."gl_accounts" validate constraint "gl_accounts_tenant_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_ap_control_account_id_fkey" FOREIGN KEY (ap_control_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_ap_control_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_ar_control_account_id_fkey" FOREIGN KEY (ar_control_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_ar_control_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_bank_account_id_fkey" FOREIGN KEY (bank_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_bank_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_cash_account_id_fkey" FOREIGN KEY (cash_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_cash_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_default_expense_account_id_fkey" FOREIGN KEY (default_expense_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_default_expense_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_default_revenue_account_id_fkey" FOREIGN KEY (default_revenue_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_default_revenue_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_tenant_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_vat_input_account_id_fkey" FOREIGN KEY (vat_input_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_vat_input_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_vat_output_account_id_fkey" FOREIGN KEY (vat_output_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_vat_output_account_id_fkey";

alter table "public"."gl_control_accounts" add constraint "gl_control_accounts_wht_payable_account_id_fkey" FOREIGN KEY (wht_payable_account_id) REFERENCES public.gl_accounts(id) not valid;

alter table "public"."gl_control_accounts" validate constraint "gl_control_accounts_wht_payable_account_id_fkey";
...
alter table "public"."journal_entries" add constraint "journal_entries_source_type_check" CHECK ((source_type = ANY (ARRAY['supplier_invoice'::text, 'receivable_invoice'::text, 'cash_bank_transaction'::text, 'opening_balance'::text, 'manual'::text]))) not valid;

alter table "public"."journal_entries" validate constraint "journal_entries_source_type_check";
...
alter table "public"."journal_entry_lines" add constraint "journal_entry_lines_gl_account_id_fkey" FOREIGN KEY (gl_account_id) REFERENCES public.gl_accounts(id) not valid;
...
alter table "public"."journal_entry_lines" add constraint "journal_entry_lines_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE not valid;

alter table "public"."journal_entry_lines" validate constraint "journal_entry_lines_tenant_id_fkey";
...
CREATE OR REPLACE FUNCTION public.post_journal_entry(p_tenant_id uuid, p_source_type text, p_source_id uuid, p_entry_date date, p_description text, p_lines jsonb)
...
create or replace view "public"."v_account_ledger" as  SELECT jel.tenant_id,
...
create or replace view "public"."v_wht_report" as  SELECT si.tenant_id,
    si.organization_id,
    si.id AS source_id,
    si.invoice_number,
    si.invoice_date,
    ...
    (((date_trunc('month'::text, (si.invoice_date)::timestamp with time zone) + '1 mon'::interval) + '14 days'::interval))::date AS remittance_due_date
   FROM (public.supplier_invoices si
     LEFT JOIN public.accounts a ON ((a.id = si.vendor_account_id)))
  WHERE (si.wht_amount > (0)::numeric);
...
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "accounting_periods_select"
  on "public"."accounting_periods"
  as permissive
  for select
  to public
...
with check (((tenant_id = public.get_my_tenant_id()) AND public.is_tenant_admin()));
  ...
  create policy "approval_assignments_select"
  on "public"."approval_assignments"
  as permissive
  for select
  to authenticated
using ((((tenant_id = public.get_my_tenant_id()) AND public.is_tenant_admin()) OR (user_id = ( SELECT auth.uid() AS uid))));
...
using ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_accounts_insert"
  on "public"."gl_accounts"
  as permissive
  for insert
  to public
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_accounts_select"
  on "public"."gl_accounts"
  as permissive
  for select
  to public
using ((public.is_finance_team_member(NULL::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_accounts_update"
  on "public"."gl_accounts"
  as permissive
  for update
  to public
...
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_control_accounts_delete"
  on "public"."gl_control_accounts"
  as permissive
  for delete
  to public
using ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_control_accounts_insert"
  on "public"."gl_control_accounts"
  as permissive
  for insert
  to public
with check ((public.is_finance_team_member('finance'::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_control_accounts_select"
  on "public"."gl_control_accounts"
  as permissive
  for select
  to public
using ((public.is_finance_team_member(NULL::text) AND (tenant_id = public.get_my_tenant_id())));
  ...
  create policy "gl_control_accounts_update"
  on "public"."gl_control_accounts"
  as permissive
  for update
  to public
...
CREATE TRIGGER trg_check_accounting_period_no_overlap BEFORE INSERT OR UPDATE OF period_start, period_end ON public.accounting_periods FOR EACH ROW EXECUTE FUNCTION public.check_accounting_period_no_overlap();

CREATE TRIGGER trg_stamp_accounting_period_close BEFORE UPDATE OF status ON public.accounting_periods FOR EACH ROW EXECUTE FUNCTION public.stamp_accounting_period_close();
...
CREATE TRIGGER trg_post_cash_bank_transaction AFTER INSERT ON public.cash_bank_transactions FOR EACH ROW EXECUTE FUNCTION public.trg_post_cash_bank_transaction();
...
CREATE CONSTRAINT TRIGGER trg_check_journal_entry_balanced AFTER INSERT OR DELETE OR UPDATE ON public.journal_entry_lines DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE FUNCTION public.check_journal_entry_balanced();
...
CREATE TRIGGER trg_post_receivable_invoice AFTER INSERT ON public.receivable_invoices FOR EACH ROW EXECUTE FUNCTION public.trg_post_receivable_invoice();
...
CREATE TRIGGER trg_post_supplier_invoice AFTER INSERT ON public.supplier_invoices FOR EACH ROW EXECUTE FUNCTION public.trg_post_supplier_invoice();
